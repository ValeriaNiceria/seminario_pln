...
- **Obter os dados:**
  Agora que já temos uma pergunta, precisamos conseguir os dados que à respondam, sendo assim, irei utilizar como fonte de dados, o que as pessoas estão conversando no Twitter.

- **Limpar:**
  E com os nossos dados em mãos, iremos realizar outra etapa do processo de mineração de dados, que é a limpeza dos nossos dados, removendo caracteres especiais, como acentos, pontuações, colocando todas as palavras em uma só estrutura, como por exemplo, maiúsculo ou minúsculo e remover todas palavras de ligação, conhecidas como **stopwords**, como: _a, e, os, de, com, etc_. Que serão irrelevantes para a pergunta que queremos responder.
