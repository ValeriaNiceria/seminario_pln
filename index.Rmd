...
- _'tydeverse'_ paÉ um pacote, que possui uma coleção de pacotes inclusos, para ajudar na manipulação dos dados.
...
E podemos visualizar como os nossos termos estão agrupados, e para isso geraremos um dendrograma, que é um diagrama de árvore.
