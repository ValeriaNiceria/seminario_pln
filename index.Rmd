...
- **Limpar:**
  E com os nossos dados em mãos, iremos realizar outra etapa do processo, que é a limpeza dos nossos dados, removendo caracteres especiais, como acentos, pontuações, colocando todas as palavras em uma só estrutura, como, por exemplo, maiúsculo ou minúsculo e removeremos todas as **stopwords**, que são palavras irrelevantes para a pergunta que queremos responder.
